...
if sys.argv[1] == "all" or sys.argv[1] == "helm":
    ...
    with open(os.path.join(os.getcwd(), 'parameters/stratum-helm-charts.json'), 'r') as file:
...
if sys.argv[1] == "all" or sys.argv[1] == "oras":
    ...
    command_oras_push = ["oras", "push", acr_cred["acrServerUrl"].replace("https://", "") + "/" + armTemplateName + ":" + armTemplateVersion, "bicep/arm_cnf_template.json"]
